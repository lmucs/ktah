...
$(function () {
  ktah.types.WoodWall = ktah.types.Effect.extend({
    defaults: {
      type: 'woodWall',
      characterClass: null,
      sceneNode: null,
    ...
    getSceneNode: function () {
      ...
      billboard.Pos.Y = 30;
      billboard.getMaterial(0).Tex1 = ktah.engine.getTextureManager().getTexture("../assets/effects/architect/woodWall.jpg", true);

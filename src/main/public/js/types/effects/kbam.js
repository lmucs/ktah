...
$(function () {
  ktah.types.Kbam = ktah.types.Effect.extend({
    defaults: {
      type: 'kbam',
      characterClass: null,
      sceneNode: null,
    ...
    getSceneNode: function () {
      ...
      billboard.Pos.Y = 30;
      billboard.getMaterial(0).Tex1 = ktah.engine.getTextureManager().getTexture("../assets/effects/tinkerer/kbam.png", true);

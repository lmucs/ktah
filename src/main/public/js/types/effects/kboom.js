...
$(function () {
  ktah.types.Kboom = ktah.types.Effect.extend({
    defaults: {
      type: 'kboom',
      characterClass: null,
      sceneNode: null,
    ...
    getSceneNode: function () {
      ...
      billboard.Pos.Y = 30;
      billboard.getMaterial(0).Tex1 = ktah.engine.getTextureManager().getTexture("../assets/effects/tinkerer/kboom.png", true);
